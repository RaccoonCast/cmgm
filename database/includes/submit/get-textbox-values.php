...
'city', 'state', 'carrier_multiple', 'permit_cellsite', 'permit_suspected_carrier', 'trails_match', 'other_carriers_dont',
'antennas_match_carrier', 'evidence_link', 'cellmapper_triangulation', 'image_evidence', 'verified_by_visit', 'sector_split_match',
'contact_permit_carrier', `archival_antenna_addition`, `only_reasonable_location`);
