...
'NR_1', 'NR_2', 'pci_match','id_pattern_match', 'sector_match', 'bio', 'status', 'evidence_link', 'address', 'zip', 'city',
...
'antennas_match_carrier', 'evidence_link', 'cellmapper_triangulation', 'image_evidence', 'photo_link', 'attached_file_link', 'verified_by_visit',
'sector_split_match');
