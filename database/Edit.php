...
<form action="Edit.php" autocomplete="off" id="form<?php echo $id; ?>" method="get">
  <div id="panel1">
    ...
    type="text" class="ID idList" id="LTE_2" value="<?php echo $LTE_2?>" placeholder="LTE_2" name="LTE_2"><input
    type="text" class="ID idList" id="LTE_3" value="<?php echo $LTE_3?>" placeholder="LTE_3" name="LTE_3"><input
    type="text" class="ID idList" id="LTE_4" value="<?php echo $LTE_4?>" placeholder="LTE_4" name="LTE_4"><input
    type="text" class="ID idList" id="LTE_5" value="<?php echo $LTE_5?>" placeholder="LTE_5" name="LTE_5"><input
    type="text" class="ID idList" id="LTE_6" value="<?php echo $LTE_6?>" placeholder="LTE_6" name="LTE_6"><input
    type="text" class="ID idList" id="NR_1" value="<?php echo $NR_1?>" placeholder="NR_1" name="NR_1"><input
    type="text" class="ID idList" id="NR_2" value="<?php echo $NR_2?>" placeholder="NR_2" name="NR_2">


    <br><label class="tf_a1" for="pci_match">PCI match with all IDs</label><input type="text" class="tf_a2 pci_match" name="pci_match" value="<?php echo $pci_match?>">
    <br><label class="tf_a1" for="id_pattern_match">ID pattern with all IDs</label><input type="text" class="tf_a2 id_pattern_match" name="id_pattern_match" value="<?php echo $id_pattern_match?>">
    <br><label class="tf_a1" for="sector_match">Similiar sectors with all IDs</label><input type="text" class="tf_a2 sector_match" name="sector_match" value="<?php echo $sector_match?>">
    <br><label class="tf_a1" for="other_user_map_primary">Other user mapped primary</label><input type="text" class="tf_a2 other_user_map_primary" name="other_user_map_primary" value="<?php echo $sector_match?>">
  ...
  <div id="panel2">
    ...
    <br><label class="tf_b1" for="permit_score">Permit Score</label><input type="text" class="tf_b2 permit_score" name="permit_score" value="<?php echo $permit_score?>">
    <br><label class="tf_b1" for="trails_match">Trails Match</label><input type="text" class="tf_b2 trails_match" name="trails_match" value="<?php echo $trails_match?>">
    <br><label class="tf_b1" for="carriers_dont_trail_match">Number of carriers CellMapper data rules out</label><input type="text" class="tf_b2 carriers_dont_trail_match" name="carriers_dont_trail_match" value="<?php echo $carriers_dont_trail_match?>">
    <br><label class="tf_b1" for="antennas_match_carrier"><abbr title="(1-100)&#013;0 being not at all&#013;100 being perfectly)">Antennas match carrier</abbr></label><input type="text" class="tf_b2 antennas_match_carrier" name="antennas_match_carrier" value="<?php echo $antennas_match_carrier?>">
    <br><label class="tf_b1" for="cellmapper_triangulation"><abbr title="(1-100)&#013;0 being not at all&#013;100 being perfectly)">CellMapper Triangulation</abbr></label><input type="text" class="tf_b2 cellmapper_triangulation" name="cellmapper_triangulation" value="<?php echo $cellmapper_triangulation?>">
    <br><label class="tf_b1" for="image_evidence"><abbr title="(1-100)&#013;0 being none&#013;100 being perfect)">Image evidence</abbr></label><input type="text" class="tf_b2 image_evidence" name="image_evidence" value="<?php echo $image_evidence?>">
    <br><label class="tf_b1" for="verified_by_visit"><abbr title="(1-100)&#013;0 being not at all&#013;100 very thorough)">Verified by visit</abbr></label><input type="text" class="tf_b2 verified_by_visit" name="verified_by_visit" value="<?php echo $verified_by_visit?>">
    <br><label class="tf_b1" for="sector_split_match"><abbr title="(1-100)&#013;0 being not at all&#013;100 being perfectly)">Sector split match</abbr></label><input type="text" class="tf_b2 sector_split_match" name="sector_split_match" value="<?php echo $sector_split_match?>">
    <br><label class="tf_b1" for="archival_antenna_addition">Number of visibile antenna modifications</abbr></label><input type="text" class="tf_b2 archival_antenna_addition" name="archival_antenna_addition" value="<?php echo $archival_antenna_addition?>">
    <br><label class="tf_b1" for="only_reasonable_location"><abbr title="(1-100)&#013;0 being not at all&#013;100 being perfectly)">Only reasonable location</abbr></label><input type="text" class="tf_b2 only_reasonable_location" name="only_reasonable_location" value="<?php echo $only_reasonable_location?>">
    <br><label class="tf_b1" for="alt_carriers_here">Number of other carriers here</label><input type="text" class="tf_b2 alt_carriers_here" name="alt_carriers_here" value="<?php echo $alt_carriers_here?>">
    </div>
</tbody>
</table>
