...
//for part of if statement for later
$searchForValue = ',';
...
elseif( strpos($data, $searchForValue) !== false ) {
...
echo '<meta http-equiv="refresh" content="0; url=Hub.php?latitude=' . $latitude . '&longitude=' . $longitude . '">';
} else { // Google Maps search for the entered data (Burger King -> find closest burger king's LAT,LONG (from favorite location))
