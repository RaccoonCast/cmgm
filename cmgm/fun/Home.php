<?php
    ...
    if (!isset($_GET['date']) && !isset($_GET['year'])) include "includes/count_records_by_timeframe.php";
    ...
    if (!isset($_GET['date']) && !isset($_GET['year'])) include "includes/count_records_by_year.php";

    // Count most common cities..
    if (!isset($_GET['city'])) include "includes/count_most_common_cities.php";

    // Count most common counties..
    if (!isset($_GET['county'])) include "includes/count_most_common_counties.php";
