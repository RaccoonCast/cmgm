...
include $SITE_ROOT . '/fun/includes/functions/gen_meta_tags.php';

$percent_stat = isset($_GET['percents_view']) ? getPercent_2($total, $total_out_of_everything) : '';
echo !($total == $total_out_of_everything)
    ? "<h3>With your current filters applied, you're looking at $total_text out of $total_out_of_everything CMGM pins$percent_stat. </h3>"
    : '<br>';
