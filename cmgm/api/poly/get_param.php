...
$newest_date          = get_param('newest_date', '/^[<>]?\d{4}-\d{2}-\d{2}$/', 'Invalid last seen date provided, expected input like ">2025-01-01" or "2025-05-25"');
...
$useAggregateTable    = isset($_GET['useAggregateTable']) ? true : false;
