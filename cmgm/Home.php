   ...
   <body class="flex">
     ...
     <form id="form" action="/" method="post" autocomplete="off">
       <div class="buttons">
        ...
        type="button" class="cmgm-btn sb w-100" style="color:#6BE63E" id="link04" name="goto" onclick="redir('<?php echo function_goto($latitude,$longitude,@$carrier,@$address,@$zip,@$city,@$state,"CellMapper",NULL,$cm_mapType,$cm_groupTowers,$cm_showLabels,$cm_showLowAcc,$cm_zoom,@$cm_netType) ?>');" value="CellMapper"><input 
