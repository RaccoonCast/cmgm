...
if (!empty($street_view_a) && @$no_street_view != 'true') echo '<a class="widget widget_emote" target="_blank" title="Street View URL" class="widget" href="https://'.str_replace("https://", "",$street_view_a).'">🚗</a>';
