...
// $cm_zoom = "18";
// $cm_netType = "LTE";
function cellmapperLink ($cm_latitude,$cm_longitude,$cm_zoom,$cm_carrier,$cm_netType,$cm_mapType,$cm_groupTowers,$cm_showLabels,$cm_showLowAcc,$item = "0",$tac = "0",$html_format = false) {
  if (empty($tac)) $tac = "0";
  ...
  if ($html_format == "true") return '<a href="https://www.cellmapper.net/map?' . $beginning . 'type=' . $cm_netType . '&latitude=' . $cm_latitude . '&longitude=' . $cm_longitude . '&zoom=' . $cm_zoom . '&clusterEnabled=' . $cm_groupTowers . '&showTowerLabels=' . $cm_showLabels . '&showOrphans=' . $cm_showLowAcc . '&ppT=' . $item . '&ppL=' . $tac . '">' . $item . '</a>';
