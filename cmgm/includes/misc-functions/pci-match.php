...
if (!empty($_POST['data'])) {
  ...
  $sql = "SELECT LTE_1,LTE_2,LTE_3,LTE_4,LTE_5,LTE_6,LTE_7,LTE_8,LTE_9,NR_1,NR_2,NR_3,NR_4,NR_5,NR_6 FROM db $db_vars";
  ...
  foreach($result as $value) {
    $id = @mysqli_fetch_array(mysqli_query($conn, "SELECT id FROM db WHERE LTE_1='$value' OR LTE_2='$value' OR LTE_3='$value' OR LTE_4='$value' OR LTE_5='$value' OR LTE_5='$value' OR LTE_6='$value' OR NR_1='$value' OR NR_2='$value'"))['id'];
    $idList = @$idList . "," . $id;
  }
