<?php
if (isset($maps_api_key) && $goto != "CellMapper" && $goto != "Google Maps" && $goto != "Street View" && $goto != "Beta" && $goto != "DB-Edit" && $goto != "DB-Map") {
...
mysqli_query($conn, "UPDATE userID SET gmaps_util = gmaps_util + 1 WHERE userIP = '$userIP'");
