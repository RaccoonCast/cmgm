...
if (@$_POST['goto'] != "HomeSmart" && isset($_POST['data'])) {
  ...
  if (@$_POST['goto'] != "Edit") redir_2(convert($data,@$_POST['goto'],$default_latitude,$default_longitude,$maps_api_key,$userID,$default_carrier,$cm_mapType,$cm_groupTowers,$cm_showLabels,$cm_showLowAcc,$cm_zoom),"0");
