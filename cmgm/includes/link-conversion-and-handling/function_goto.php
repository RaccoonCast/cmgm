...
if ($goto_page == "Cell Map" || $goto_page == "Poly Map") {
...
if ($goto_page == "Look Around") return "https://lookmap.skzk.dev/#c=20/$latitude/$longitude&p=$latitude/$longitude&a=360/34.00";
