...
if (str_contains($data, 'map?')) {
  ...
  // This is designed to catch stuff from overrideData, might catch other stuff by mistake and that's fine I guess.
  preg_match('/Latitude=([^&]+).*?Longitude=([^&]+)/', $data, $matches);
