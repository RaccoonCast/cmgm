    ...
    foreach ($row as $field => $value) {
      ...
      $sepCount = ($colCount++);
                  ...
                  switch ($sepCount) {
                    ...
                    echo nl2br('<a target="_top" class="widget widget_emote" href="Map.php?latitude=' . $latitude . '&longitude=' . $longitude . '&zoom=18' . $url_suffix . '"><abbr title="View map here">🌎</abbr></a>');
