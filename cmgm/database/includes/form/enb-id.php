...
<?php if(isMobile()){
  ...
  document.getElementById("extraENBID").setAttribute('style', 'display: none');
  document.getElementById("LTE_1").setAttribute('style', 'width: 5.67%!important;');
  document.getElementById("LTE_2").setAttribute('style', 'width: 5.67%!important;');
  document.getElementById("LTE_3").setAttribute('style', 'width: 5.67%!important;');
  document.getElementById("LTE_4").setAttribute('style', 'width: 5.67%!important;');
  document.getElementById("LTE_5").setAttribute('style', 'width: 5.67%!important;');
  document.getElementById("LTE_6").setAttribute('style', 'width: 5.67%!important;');
