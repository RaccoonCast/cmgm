...
$headers = @get_headers("https://cmgm.us/database/uploads/" . $file); 
...
if (!empty($$value)) {
    ...
    elseif (preg_match('/^(?:image|canon|misc|photo)/', $$value)) { {$$val = '<a class="pad-small-link pad-small-link-mobile" target="_blank" href="https://cmgm.us/database/uploads/' . $$value . '">' . $link_suffix . '</a>';}
    } else { $$val = null; }
}
