...
} if (isset($NR_1_mv)) { ?><p class="pad-small-link pad-small-link-mobile3">-</p><a class="pad-small-link pad-small-link-mobile2" rel="noreferrer noopener" target="_blank" href="<?php if (isset($NR_1_mv)){echo $NR_1_mv;}?>"><?php if (isMobile()) echo "NR_"?>1</a><?php } if (isset($NR_2_mv)){?><a
