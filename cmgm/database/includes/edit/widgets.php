...
echo '<a class="widget widget_emote" target="_blank" title="Poly Map" href="https://cmgm.us/poly/Map.php?latitude='.$latitude.'&longitude='.$longitude.'&zoom=16&plmn='.$plmn.'&rat=LTE&viewMode=cells">🔷</a>';
