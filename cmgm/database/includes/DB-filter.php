...
elseif ($key == "filesearch") { $db_vars = " AND ( evidence_a LIKE '%$fs%' OR evidence_b LIKE '%$fs%' OR evidence_c LIKE '%$fs%' OR photo_a LIKE '%$fs%' OR photo_b LIKE '%$fs%' OR photo_c LIKE '%$fs%' OR photo_d LIKE '%$fs%' OR photo_e LIKE '%$fs%' OR photo_f LIKE '%$fs%' OR extra_a LIKE '%$fs%' OR extra_b LIKE '%$fs%' OR extra_c LIKE '%$fs%' OR extra_d LIKE '%$fs%' OR extra_e LIKE '%$fs%' OR extra_f LIKE '%$fs%' OR bingmaps_a LIKE '%$fs%' OR bingmaps_b LIKE '%$fs%' OR bingmaps_c LIKE '%$fs%' )" . @$db_vars; }
elseif ($key == "search") { $db_vars = " AND ( tags LIKE '%$fs%' OR notes LIKE '%$fs%' OR site_id LIKE '%$fs%' OR evidence_a LIKE '%$fs%' OR evidence_b LIKE '%$fs%' OR evidence_c LIKE '%$fs%' OR photo_a LIKE '%$fs%' OR photo_b LIKE '%$fs%' OR photo_c LIKE '%$fs%' OR photo_d LIKE '%$fs%' OR photo_e LIKE '%$fs%' OR photo_f LIKE '%$fs%' OR extra_a LIKE '%$fs%' OR extra_b LIKE '%$fs%' OR extra_c LIKE '%$fs%' OR extra_d LIKE '%$fs%' OR extra_e LIKE '%$fs%' OR extra_f LIKE '%$fs%' OR bingmaps_a LIKE '%$fs%' OR bingmaps_b LIKE '%$fs%' OR bingmaps_c LIKE '%$fs%' )" . @$db_vars; }
elseif ($key == "filesearchexclude") { $db_vars = " AND ( evidence_a NOT LIKE '%$fs%' AND evidence_b NOT LIKE '%$fs%' AND evidence_c NOT LIKE '%$fs%' AND photo_a NOT LIKE '%$fs%' AND photo_b NOT LIKE '%$fs%' AND photo_c NOT LIKE '%$fs%' AND photo_d NOT LIKE '%$fs%' AND photo_e NOT LIKE '%$fs%' AND photo_f NOT LIKE '%$fs%' AND extra_a NOT LIKE '%$fs%' AND extra_b NOT LIKE '%$fs%' AND extra_c NOT LIKE '%$fs%' AND extra_d NOT LIKE '%$fs%' AND extra_e NOT LIKE '%$fs%' AND extra_f NOT LIKE '%$fs%' AND bingmaps_a NOT LIKE '%$fs%' AND bingmaps_b NOT LIKE '%$fs%' AND bingmaps_c NOT LIKE '%$fs%' )" . @$db_vars; }
elseif ($key == "filesearchprefix") { $db_vars = " AND ( evidence_a LIKE '$fs%' OR evidence_b LIKE '$fs%' OR evidence_c LIKE '$fs%' OR photo_a LIKE '$fs%' OR photo_b LIKE '$fs%' OR photo_c LIKE '$fs%' OR photo_d LIKE '$fs%' OR photo_e LIKE '$fs%' OR photo_f LIKE '$fs%' OR extra_a LIKE '$fs%' OR extra_b LIKE '$fs%' OR extra_c LIKE '$fs%' OR extra_d LIKE '$fs%' OR extra_e LIKE '$fs%' OR extra_f LIKE '$fs%' OR bingmaps_a LIKE '$fs%' OR bingmaps_b LIKE '$fs%' OR bingmaps_c LIKE '$fs%' )" . @$db_vars; }
...
elseif ($key == "filesearchsuffix") { $db_vars = " AND ( evidence_a LIKE '%$fs' OR evidence_b LIKE '%$fs' OR evidence_c LIKE '%$fs' OR photo_a LIKE '%$fs' OR photo_b LIKE '%$fs' OR photo_c LIKE '%$fs' OR photo_d LIKE '%$fs' OR photo_e LIKE '%$fs' OR photo_f LIKE '%$fs' OR extra_a LIKE '%$fs' OR extra_b LIKE '%$fs' OR extra_c LIKE '%$fs' OR extra_d LIKE '%$fs' OR extra_e LIKE '%$fs' OR extra_f LIKE '%$fs' OR bingmaps_a LIKE '%$fs' OR bingmaps_b LIKE '%$fs' OR bingmaps_c LIKE '%$fs' )" . @$db_vars; }
