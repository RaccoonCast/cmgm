...
<?php if(isset($_GET['new'])) {
  ?> <title>EvilCM - New</title> <?php
} else {
  ?> <title>EvilCM - Edit (<?php echo $LTE_1; ?>)</title> <?php
} ?>
</head>
<body>
...
<?php
$no_edit = "true";
if (!isset($_GET['new'])) include "../includes/widgets/widgets.php";
if (!isset($_GET['new'])) include "includes/edit/prev_next.php";
?>
