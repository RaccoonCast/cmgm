...
foreach ($formData as $index => $data) {
    ...
    if (isset($data['cellListDepri']) && $data['cellListDepri'] == '-') {
       if ($rat == "LTE") {
        ...
        if ($plmn == 310410 || $plmn == 313100) $cellList_depri = [7,8,9,10,11,12,13,15,16,17,18,19,20,22,23,24,25,26,27,185,186,187,188,189,190,191,192,193,194,195,196,197,198,35,63,99,28,56,91,182,183,181,42,70,107,49,63,115,179,171,186,201,202,203,204,205,92,93,94,95,100,101,102,108,109,110,149,150,151,152,153,154,155,171,172,173,174,217,218,219,220];
        ...
        if ($plmn == 310260) $cellList_depri = [1,2,3,4,11,12,13,14,21,22,23,24,41,42,43,51,52,53,54,301,302,303,304,305,306,311,312,313,314,315,316,321,322,323,324,325,326,351,352,353,371,372,373,401,402,403,404,411,412,413,414];
        if ($plmn == 311480) $cellList_depri = [26,27,42,43,58,59,74,75,25,41,57,20,36,52,68,23,39,55]; // n77 + n77suppl + n2 + n66 
        if ($plmn == 310410) $cellList_depri = [];
       }
