...
foreach ($formData as $index => $data) {
    ...
    if (isset($data['cellListDepri']) && $data['cellListDepri'] == '-') {
       if ($rat == "LTE") {
        ...
        if ($plmn == 310410 || $plmn == 313100) $cellList_depri = [7,8,9,10,11,12,13,15,16,17,18,19,20,22,23,24,25,26,27,185,186,187,188,189,190,191,192,193,194,195,196,197,198,35,63,99,28,56,91,182,183,181,42,70,107,49,63,115,179,171,186,201,202,203,204,205,92,93,94,95,100,101,102,108,109,110,149,150,151,152,153,154,155,171,172,173,174,175,176,177,217,218,219,220,124,125,126,140,141,142,132,133,134,221,222,223,224,227,228,229];
